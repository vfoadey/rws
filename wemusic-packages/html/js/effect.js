...
function animate(){if(animateHeader){ctx.clearRect(0,0,width,height);for(var i in points){if(Math.abs(getDistance(target,points[i]))<4000){points[i].active=0.35;points[i].circle.active=0.65;}else if(Math.abs(getDistance(target,points[i]))<20000){points[i].active=0.15;points[i].circle.active=0.35;}else if(Math.abs(getDistance(target,points[i]))<40000){points[i].active=0.025;points[i].circle.active=0.15;}else{points[i].active=0;points[i].circle.active=0;}
